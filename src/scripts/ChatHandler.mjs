...
export default class ChatHandler {
	...
	static _getFont(actor) {
		let actorFont = actor.flags.vino?.font;
	...
	static _getPreferredSide(actor) {
		let preferredSide = actor.flags.vino?.preferredSide;
